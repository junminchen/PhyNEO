...
pdb = '6_1.pdb'
# pdb = 'density_0.03338.pdb'
f_xml = '/share/home/junmin/group/test_jax_eann_water/water_cmd/forcefield.xml'
r_xml = '/share/home/junmin/group/test_jax_eann_water/water_cmd/residues.xml'
psr = 'params_eann.pickle'
...
def admp_calculator(positions, box, pairs):
    ...
    E_eann = eann_force.get_energy(positions, box, pairs, params_eann)
    # return E_pme - E_disp + E_sr + E_intra + E_eann
    return E_eann

tot_force = jit(jax.value_and_grad(admp_calculator,argnums=(0)))
# compile tot_force function
E, F = tot_force(positions, box, pairs)
print(E) 
