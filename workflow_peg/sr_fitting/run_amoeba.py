...
if __name__ == '__main__':
    ...
    # forcefield = ForceField('cocco_opls.xml')
    ...
    # debug in main node
    # platform_AB = Platform.getPlatformByName('CPU')
    # platform_A = Platform.getPlatformByName('CPU')
    # platform_B = Platform.getPlatformByName('CPU')
    ...
    n_atoms = len(pos_AB0)
    n_atoms_A = len(np.array(pdb_A.positions._value)*10)
