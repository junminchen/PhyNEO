#ifndef OPENMM_CUDAMPIDKERNELSOURCES_H_
#define OPENMM_CUDAMPIDKERNELSOURCES_H_
...
class OPENMM_EXPORT CudaMPIDKernelSources {
public:
...
#endif /*OPENMM_CUDAMPIDKERNELSOURCES_H_*/
